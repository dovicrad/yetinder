 ...
 */
final class Version20220815164707 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_D88926226FD936CB');
        $this->addSql('CREATE TEMPORARY TABLE __temp__rating AS SELECT id, yeti_id, value, date FROM rating');
        $this->addSql('DROP TABLE rating');
        $this->addSql('CREATE TABLE rating (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, yeti_id INTEGER NOT NULL, value INTEGER NOT NULL, date DATETIME NOT NULL, CONSTRAINT FK_D88926226FD936CB FOREIGN KEY (yeti_id) REFERENCES yeti (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO rating (id, yeti_id, value, date) SELECT id, yeti_id, value, date FROM __temp__rating');
        $this->addSql('DROP TABLE __temp__rating');
        $this->addSql('CREATE INDEX IDX_D88926226FD936CB ON rating (yeti_id)');
        $this->addSql('DROP INDEX IDX_6525CCFF5B7AF75');
        $this->addSql('CREATE TEMPORARY TABLE __temp__yeti AS SELECT id, address_id, first_name, last_name, weight, height, image FROM yeti');
        $this->addSql('DROP TABLE yeti');
        $this->addSql('CREATE TABLE yeti (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, address_id INTEGER DEFAULT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, weight DOUBLE PRECISION NOT NULL, height DOUBLE PRECISION NOT NULL, image VARCHAR(255) DEFAULT NULL, CONSTRAINT FK_6525CCFF5B7AF75 FOREIGN KEY (address_id) REFERENCES address (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO yeti (id, address_id, first_name, last_name, weight, height, image) SELECT id, address_id, first_name, last_name, weight, height, image FROM __temp__yeti');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__rating AS SELECT id, yeti_id, value, date FROM rating');
        $this->addSql('DROP TABLE rating');
        $this->addSql('CREATE TABLE rating (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, yeti_id INTEGER NOT NULL, value INTEGER NOT NULL, date DATETIME NOT NULL)');
        $this->addSql('INSERT INTO rating (id, yeti_id, value, date) SELECT id, yeti_id, value, date FROM __temp__rating');
        $this->addSql('DROP TABLE __temp__rating');
        $this->addSql('CREATE INDEX IDX_D88926226FD936CB ON rating (yeti_id)');
        $this->addSql('DROP INDEX IDX_6525CCFF5B7AF75');
        $this->addSql('CREATE TEMPORARY TABLE __temp__yeti AS SELECT id, address_id, first_name, last_name, weight, height, image FROM yeti');
        $this->addSql('DROP TABLE yeti');
        $this->addSql('CREATE TABLE yeti (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, address_id INTEGER DEFAULT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, weight DOUBLE PRECISION NOT NULL, height DOUBLE PRECISION NOT NULL, image VARCHAR(255) DEFAULT NULL)');
        $this->addSql('INSERT INTO yeti (id, address_id, first_name, last_name, weight, height, image) SELECT id, address_id, first_name, last_name, weight, height, image FROM __temp__yeti');
        $this->addSql('DROP TABLE __temp__yeti');
        $this->addSql('CREATE INDEX IDX_6525CCFF5B7AF75 ON yeti (address_id)');
    }
