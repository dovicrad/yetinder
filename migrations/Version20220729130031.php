 ...
 */
final class Version20220729130031 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__rating AS SELECT id, value, date FROM rating');
        ...
        $this->addSql('INSERT INTO rating (id, value, date) SELECT id, value, date FROM __temp__rating');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__rating AS SELECT id, value, date FROM rating');
        $this->addSql('DROP TABLE rating');
        $this->addSql('CREATE TABLE rating (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, value INTEGER NOT NULL, date DATETIME NOT NULL)');
        $this->addSql('INSERT INTO rating (id, value, date) SELECT id, value, date FROM __temp__rating');
        $this->addSql('DROP TABLE __temp__rating');
        $this->addSql('DROP INDEX IDX_6525CCFF5B7AF75');
        $this->addSql('CREATE TEMPORARY TABLE __temp__yeti AS SELECT id, address_id, first_name, last_name, weight, height FROM yeti');
